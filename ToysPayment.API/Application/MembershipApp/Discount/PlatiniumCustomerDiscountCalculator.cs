...
{
    public class PlatiniumCustomerDiscountCalculator : IDiscountCalculator
    {
        private readonly IApplicationConfiguration _applicationConfiguration;
        private readonly MembershipType _membershipType;

        public PlatiniumCustomerDiscountCalculator(IApplicationConfiguration applicationConfiguration)
        {
